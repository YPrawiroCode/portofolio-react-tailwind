...
const Card = () => {
  return (
    <div className="w-full">
      <div className="flex flex-col justify-center max-w-xs mx-auto bg-white shadow-2x1 rounded-xl p-5">
        <div className="">
          <img
        ...
        <div className="text-center mt-5">
          <p className="text-xl sm:text-2xl text-gray-900">Yusuf Prawiro</p>
